...
class Contract(Base):
    ...
    total_fee: Mapped[Numeric] = mapped_column(Numeric(10, 2), nullable=False)
    ...
    travel_expenses: Mapped[Numeric] = mapped_column(Numeric(10, 2), nullable=True)
    accommodation_expenses: Mapped[Numeric] = mapped_column(Numeric(10, 2), nullable=True)
    other_expenses: Mapped[Numeric] = mapped_column(Numeric(10, 2), nullable=True)
